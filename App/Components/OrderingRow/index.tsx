...
const OrderingRow: React.FC<OrderingRowType> = ({
  isReverse, orderingItem, selectOrdering, selectedOrdering, toggleReverse
}) => {
  return <>
    <View style={styles.pickerRow}>
      ...
      <View style={styles.flex2}>
        <RNPickerSelect onValueChange={selectOrdering}
          items={orderingItem}
    ...
    <View style={[styles.pickerRow, styles1.marginTop10]}>
      ...
      <View style={styles.flex2}>
        <TouchableWithoutFeedback onPress={toggleReverse}>
          <View style={styles.pickerRow}>
            <Icon name={`check-box${isReverse ? '' : '-outline-blank'}`}

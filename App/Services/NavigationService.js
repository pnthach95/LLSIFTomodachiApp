...
/**
 * The navigation is implemented as a service so that
 * it can be used outside of components, for example in sagas.
 *
 ...
 * from a splashscreen to the main screen: the user should not be able to
 * go back to the splashscreen.
 *
 * @param routeName The name of the route to navigate to.
 * Routes are defined in RootScreen using createStackNavigator()
 * @param params Route parameters.

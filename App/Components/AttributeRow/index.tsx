 ...
 */
const AttributeRow: React.FC<AttributeRowType> = ({ attribute, selectAttribute }) => {
  return <View style={ApplicationStyles.row}>
    ...
    <View style={rowStyles.rightView}>
      <ScrollView horizontal
        ...
        <TouchableOpacity onPress={() => selectAttribute('')}
          style={[
        ...
        <TouchableOpacity onPress={() => selectAttribute('Smile')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectAttribute('Pure')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectAttribute('Cool')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectAttribute('All')}
          style={[
            rowStyles.standardButton,

  ...
  return <View style={ApplicationStyles.row}>
    ...
    <View style={rowStyles.rightView}>
      <ScrollView horizontal
        ...
        <TouchableOpacity onPress={() => selectRarity('')}
          style={[
        ...
        <TouchableOpacity onPress={() => selectRarity('N')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectRarity('R')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectRarity('SR')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectRarity('SSR')}
          style={[
            rowStyles.standardButton,
        ...
        <TouchableOpacity onPress={() => selectRarity('UR')}
          style={[
            rowStyles.standardButton,
